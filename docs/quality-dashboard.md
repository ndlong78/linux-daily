...
Derived quality snapshot · as of **2026-09-19**.
...
|---|---|---|
| Distro coverage & portability | **ATTENTION** | 76/81 complete · FreeBSD blocks 81/81 · violations 0 |
| Command & configuration | **PASS** | 646 blocks · 2068 lines · blockers 0 · review 0 |
| Content freshness | **PASS** | current 81 · review-due 0 · historically-valid 0 |
| Source quality | **PASS** | backed 81/81 · reviewed 81/81 · sources 269 |

## Quality evidence

### Distro portability

- Complete four-platform coverage: **76/81**
- Explicit FreeBSD blocks: **81/81**
- Linux-only semantics inside FreeBSD blocks: **0**

### Command / configuration safety

- Code blocks scanned: **646**
- Command/config lines scanned: **2068**
...
- Posts with structured source evidence: **81/81**
- Source-backed posts with mergeable review status: **81/81**
- Official/upstream technical sources: **269**
